...
const UserCard = ({ user }) => {
  ...
  return (
    <div
      key={user._id}
      className="p-4 pt-6 flex flex-col justify-between w-80 shadow border border-gray-200 rounded-md"
    >
      ...
      <div className="flex items-center justify-center gap-2 my-4 text-xs text-gray-600">
